        ...
        if FORCE_SUB_CHANNEL:
            try:
                ...
                self.LOGGER(__name__).info(
                    "Bot Berhenti. Bertanya lah kepada https://t.me/CallMeShackleTok 😘"
                )
                sys.exit()
        if FORCE_SUB_GROUP:
            try:
                ...
                self.LOGGER(__name__).info(
                    "Bot Berhenti. Bertanya lah kepada saya https://t.me/CallMeShackleTok "
                )
                sys.exit()
        try:
            ...
            self.LOGGER(__name__).info(
                "Bot Berhenti. Bertanya lah ke https://t.me/CallMeShackleTok"
            )
            sys.exit()

        self.set_parse_mode("html")
        self.LOGGER(__name__).info(
            f"[ 🌀 BOT ANDA TELAH DI AKTIFKAN OLEH  @CallMeShackleTok 🌀 ]\n\nBOT Dibuat oleh @{OWNER}\nJika @{OWNER} Membutuhkan Bantuan, Silahkan Tanyakan di Grup https://t.me/SharingUserbot"
        )
